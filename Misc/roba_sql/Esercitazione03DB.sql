...
# select concat(cognome, ' ' ,nome) as full_name
...
SELECT nome,
	...
	ORDER BY data_nascita DESC;    #DESC = decrescente
...
SELECT nome,
    ...
    data_nascita
    FROM studenti
    WHERE provincia = 'at' or provincia = 'cn' or provincia = 'no' or provincia = 'al'
	ORDER BY provincia, cognome, nome;
...
SELECT nome,
    ...
    data_nascita
    FROM studenti
    WHERE data_nascita > '1990-01-01' and data_nascita < '1999-12-31'
...
SELECT nome,
    ...
    data_nascita
    FROM studenti
    WHERE data_nascita < '1990-01-01' OR data_nascita > '1999-12-31' and genere = 'f'
	ORDER BY data_nascita DESC, cognome, nome;
